...
<div class="<?= (strpos($message,'successful') !== false) ? 'message-success' : 'message-error' ?>">
    <?= $message ?>
</div>
...
<input type="text"
name="phone"
placeholder="<?php echo __('Phone (97 or 98...)'); ?>"
...
<option value="elder"
<?= (isset($_POST['role']) && $_POST['role']=='elder') ? 'selected' : ''; ?>>
<?php echo __('Elder'); ?>
</option>

<option value="caregiver"
<?= (isset($_POST['role']) && $_POST['role']=='caregiver') ? 'selected' : ''; ?>>
<?php echo __('Caregiver'); ?>
</option>
...
<a href="login.php"><?php echo __('Login here'); ?></a>
</p>
